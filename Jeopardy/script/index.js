...
function determineWinner() {
  const player1Points = getPlayerXPoints(1);
  const player2Points = getPlayerXPoints(2);

  let winner;
  if (player1Points > player2Points) {
    winner = getPlayerXName(1);
  } else if (player2Points > player1Points) {
    winner = getPlayerXName(2);
  } else {
    winner = "It's a tie!";
  }
...
function resetBoard() {
  ...
  currentPlayer = getPlayerXName(1);
